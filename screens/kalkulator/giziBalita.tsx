...
const GiziBalita = () => {
  ...
  const calculateCorrectedHeight = (pos: string) => {
    ...
    const diff = new Date(measurementDate.getTime() - birthDate.getTime());
  ...
  const hitungBMRdanTEE = (kategori: string, weight: number, correctedHeight: number, correctedPanjangBadan: number) => {
    let BMR = 0;
    let TEE = 0;
